    ...
    <section className="relative py-24 bg-white overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 lg:px-16">
        ...
        <div className="grid md:grid-cols-2 gap-6 max-w-3xl mx-auto mb-12">
          ...
          <a
            href="tel:09068445165"
            className="group bg-slate-50 border border-slate-200 rounded-xl p-8 hover:border-blue-500 hover:shadow-lg transition-all duration-300"
            aria-label="Call Folton Marine"
          >
            <div className="flex items-center gap-4">
          ...
          <a
            href="mailto:info@foltonmarine.ng"
            className="group bg-slate-50 border border-slate-200 rounded-xl p-8 hover:border-blue-500 hover:shadow-lg transition-all duration-300"
            aria-label="Email Folton Marine"
          >
            <div className="flex items-center gap-4">
              <div className="w-14 h-14 bg-blue-600 rounded-lg flex items-center justify-center group-hover:scale-110 transition-transform">
                <Mail className="w-6 h-6 text-white" />
        ...
        <div className="text-center">
          <Link
            href="/contact"
            className="inline-flex items-center gap-3 bg-blue-600 text-white px-8 py-4 font-semibold text-lg hover:bg-blue-700 transition-all duration-300 shadow-lg hover:shadow-xl group"
          >
            Get in Touch
