...
const AboutPage = () => {
  ...
  const teamMembers = [
    ...
    {
      name: "Samuel Oluwatimilehin Ogbole",
      position: "Executive Director, Finance & Administration",
      bio: "Samuel is a results-driven business leader overseeing finance, operations, and administration at Folton Marine Services Limited. He is responsible for strengthening operational systems, driving efficiency, and supporting the company's growth across its marine and industrial services. He holds postgraduate degrees from Warwick Business School, Coventry, UK and Saïd Business School, University of Oxford, bringing global perspective to his leadership approach. Samuel is also the Founder and Executive Director of the Restored Heart Foundation, reflecting his commitment to combining business leadership with social impact.",
      image: "/director sam (1).png",
    },
    {
